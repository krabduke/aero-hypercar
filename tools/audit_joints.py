...
CIRCUITS = [
    ...
    ('cooling, left: inlet to core to tanks to engine',
     ['sidepod_inlets', 'sidepod_l', 'radiator_l', 'rad_tanks_l', 'rad_hoses_hot', 'engine']),
    ('and back to the pump',
     ['rad_tanks_l', 'rad_hoses_return', 'engine']),
    ('charge cooling, left: core to pump to the engine and back',
     ['sidepod_l', 'rad_lt_l', 'rad_lt_pump_l', 'rad_lt_hoses_l', 'engine']),
    ('charge cooling, right',
     ['sidepod_r', 'rad_lt_r', 'rad_lt_pump_r', 'rad_lt_hoses_r', 'engine']),
    ('the pumps run off the pack',
     ['battery', 'lt_pump_lead_l', 'rad_lt_pump_l']),
    ('', ['battery', 'lt_pump_lead_r', 'rad_lt_pump_r']),
    ('hot air leaves the left sidepod',
     ['sidepod_l', 'exit_louvres_l']),
    ('high voltage: the pack is one assembly',
     ['battery', 'battery_modules']),
    ('the pack feeds the inverter, on the engine\'s bellhousing',
     ['battery', 'battery_hv_terminals', 'hv_pack_pos', 'engine']),
    ('', ['battery_hv_terminals', 'hv_pack_neg', 'engine']),
    ('the inverter feeds the fans\' controllers, and they the motors',
     ['engine', 'inverter_fan_plugs', 'hv_fan_l', 'fan_controllers',
      'fan_leads', 'fan_glands', 'fan_fairing_l', 'fanduct', 'fan_stators',
      'fan_motors']),
    ('', ['inverter_fan_plugs', 'hv_fan_r', 'fan_controllers',
          'rear_frame']),
    ('', ['fan_leads', 'fan_glands', 'fan_fairing_r']),
    ('the cables are clipped to structure',
     ['hv_pack_pos', 'hv_clips', 'tub']),
    ('', ['hv_fan_r', 'hv_clips', 'gearbox']),
    ('', ['hv_fan_l', 'hv_clips', 'crash_structure']),
    ('the coolant hoses are clipped to structure',
     ['rad_hoses_return', 'hose_clips', 'bulkhead_engine']),
    ('', ['rad_lt_hoses_l', 'hose_clips', 'sidepod_l']),
    ('the feeds go through the engine cover in grommets',
     ['hv_fan_l', 'hv_grommets', 'tub']),
