...
CIRCUITS = [
    ...
    ('fan, left: floor throat to scroll to rotor to nozzle',
     ['floor_fan_throat_l', 'fan_scroll_l', 'fan_rotor_l', 'fan_nozzle_l']),
    ('fan, right',
     ['floor_fan_throat_r', 'fan_scroll_r', 'fan_rotor_r', 'fan_nozzle_r']),
    ('the fans are driven',
     ['fan_motors', 'fan_drive_l', 'fan_rotor_l']),
    ('the fan duct joins both scrolls',
     ['fan_scroll_l', 'fanduct', 'fan_scroll_r']),
    ...
    ('the rear wing is carried off its pylons',
     ['rear_wing_main', 'wing_mount_l', 'rear_pylon_l', 'fan_scroll_l']),
